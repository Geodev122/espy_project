...
class UpsertUserVariablesBuilder {
  ...
  final FirebaseDataConnect _dataConnect;  UpsertUserVariablesBuilder name(String? t) {
   _name.value = t;
   return this;
  }

  UpsertUserVariablesBuilder(this._dataConnect, {required  this.id,required  this.email,required  this.role,});
  ...
  MutationRef<UpsertUserData, UpsertUserVariables> ref() {
    UpsertUserVariables vars= UpsertUserVariables(id: id,email: email,name: _name,role: role,);
