...
class VaultFavoritesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: EspyTheme.background,
      appBar: AppBar(
                            ...
                            child: PremiumCard(
                              ...
                              child: Row(
                                children: [
                                  CircleAvatar(
                                    radius: 28,
                                    backgroundImage: prof['photoUrl'] != null ? CachedNetworkImageProvider(prof['photoUrl']) : null,
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          (prof['fullNameEn'] ?? prof['name'] ?? 'Provider').toString().toUpperCase(),
                                          style: GoogleFonts.cinzel(fontWeight: FontWeight.w900, fontSize: 13, color: EspyTheme.navyDeep),
                                        ),
                                        Text(
                                          prof['specialization'] ?? 'Verified Node',
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () => firestore.toggleFavorite(auth.user!.uid, profId, false),
                                  ),
                                ],
                              ),
                            ),
