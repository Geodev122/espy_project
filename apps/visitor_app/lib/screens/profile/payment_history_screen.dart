          ...
          : Container(
              ...
              child: StreamBuilder<List<Map<String, dynamic>>>(
                ...
                builder: (context, snapshot) {
                  ...
                  // Apply Sorting
                  txs.sort((a, b) {
                    final dynamic rawA = a['createdAt'];
                    final dynamic rawB = b['createdAt'];
                    
                    final DateTime da = (rawA is Timestamp) ? rawA.toDate() : (DateTime.tryParse(rawA?.toString() ?? '') ?? DateTime(0));
                    final DateTime db = (rawB is Timestamp) ? rawB.toDate() : (DateTime.tryParse(rawB?.toString() ?? '') ?? DateTime(0));
