...
class _SubscriptionHubScreenState extends State<SubscriptionHubScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final userData = auth.userData?.rawData ?? {};
              ...
              child: StreamBuilder<DocumentSnapshot>(
                ...
                builder: (context, pricingSnap) {
                  ...
                  return CustomScrollView(
                    slivers: [
                      _buildVaultStatusGears(l10n, userData),
                      SliverToBoxAdapter(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text('UNIT EXPANSION STORE', style: GoogleFonts.cinzel(fontSize: 10, fontWeight: FontWeight.w900, color: EspyTheme.gold, letterSpacing: 2)),
  ...
  Future<void> _handleGooglePayResult(Map<String, dynamic> paymentData, double total, AuthService auth, Map<String, double> unitPrices) async {
    ...
    try {
      ...
      final result = await googlePay.processPayment(
        ...
        amount: total,
        userType: auth.userData?['role'] ?? 'professional',
  ...
  Future<void> _handlePayment(double amount, AuthService auth, Map<String, double> unitPrices) async {
    ...
    try {
      ...
      final result = await whish.initializePayment(
        ...
        visibilityNodes: 1, // Base visibility
        serviceSlots: _extraSlots,
        practicePins: _extraPins,
        broadcasts: _extraBroadcasts, 
  ...
  Widget _buildVaultStatusGears(AppLocalizations l10n, Map<String, dynamic> userData) {
            ...
            children: [
              ...
              Consumer<UserService>(
                builder: (context, userService, child) {
                  final realData = userService.profile ?? userData;
                  
                  // Account Status (Administrative)
