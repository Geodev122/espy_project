                ...
                if (notifications.isEmpty) {
                  return Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.notifications_none_rounded, size: 64, color: EspyTheme.cognac.withOpacity(0.1)),
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: isGlobal ? EspyTheme.gold.withOpacity(0.1) : EspyTheme.cognac.withOpacity(0.1),
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      n['message'] ?? n['content'] ?? '',
                                      style: GoogleFonts.lora(fontSize: 12, color: EspyTheme.cognac.withOpacity(0.6), height: 1.5),
                                    ),
                                    const SizedBox(height: 12),
                                    Text(
                                      l10n.receivedByProtocol.toUpperCase(),
                                      style: GoogleFonts.cinzel(fontSize: 7, fontWeight: FontWeight.bold, color: EspyTheme.cognac.withOpacity(0.3), letterSpacing: 1),
                                    ),
                                  ],
                                ),
                              ),
