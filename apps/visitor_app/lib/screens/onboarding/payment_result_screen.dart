            ...
            child: Column(
              ...
              children: [
                ...
                FadeInUp(
                  ...
                  child: Text(
                    isSuccess
                      ? 'Your care nodes are now synchronized with the Lebanese network.'
                      : 'The transaction was unsuccessful. You can retry from your vault.',
                ...
                FadeInUp(
                  ...
                  child: PremiumButton(
                    label: isSuccess ? 'ENTER VAULT' : 'RETRY PROTOCOL',
                    fullWidth: true,
                    onPressed: () {
