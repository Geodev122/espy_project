            ...
            Expanded(
              child: ListView(
                ...
                children: [
                    ...
                    _buildMenuItem(context, LucideIcons.users, 'USERS', UsersManagerScreen()),
                    ...
                    _buildMenuItem(context, LucideIcons.map, 'GEOGRAPHY', TaxonomyManagerScreen()),
                    _buildMenuItem(context, LucideIcons.settings, 'SERVICES', ServiceManagementScreen()),
                    _buildMenuItem(context, LucideIcons.megaphone, 'BROADCASTS', BroadcastGovernanceScreen()),
                    _buildMenuItem(context, LucideIcons.phone, 'SOS NUMBERS', SosManagerScreen()),

                    const SizedBox(height: 24),
                    _buildSectionHeader('ECONOMY'),
                    _buildMenuItem(context, LucideIcons.banknote, 'FINANCE', FinanceManagerScreen()),
                    _buildMenuItem(context, LucideIcons.package, 'TOKEN PACKAGES', TokenPackageScreen()),
                    _buildMenuItem(context, LucideIcons.tag, 'ELEMENT PRICING', ElementPricingScreen()),

                    const SizedBox(height: 24),
                    _buildSectionHeader('DEVELOPER'),
                    _buildMenuItem(context, LucideIcons.database, 'MASTER SEEDING', SeedManagerPage()),
                ],
              ),
            ),
            _buildFooter(auth),
