                ...
                if (request['userId'] != _firestore.getCurrentUserId)
                  PremiumButton(
                    ...
                    onPressed: () async {
                      ...
                      final userSector = (user?['sectorId'] ?? "General Care").toString().toUpperCase();
                      ...
                      if (targetWhatsapp != null && targetWhatsapp.isNotEmpty) {
                        final msg = "Hello, I am $userName, a $userRole in the $userSector sector. I am responding to your Espy request: '$reqTitle'. How can I assist you today?";
