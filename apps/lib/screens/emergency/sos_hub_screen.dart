      ...
      children: [
        ...
        Expanded(
          child: StreamBuilder<List<Map<String, dynamic>>>(
            stream: _emergencyService.getEmergencySections(countryId: _selectedCountryId),
      ...
      builder: (context, snapshot) {
        ...
        return Container(
          ...
          child: DropdownButtonFormField<String>(
            ...
            hint: const Text("SELECT COUNTRY", style: TextStyle(color: Colors.white38, fontSize: 10)),
            items: [
              const DropdownMenuItem(value: null, child: Text("DEFAULT (GLOBAL)")),
