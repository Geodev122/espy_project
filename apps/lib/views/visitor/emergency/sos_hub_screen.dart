...
class Pulse extends StatefulWidget {
  final Widget child;
  final bool infinite;
  const Pulse({super.key, required this.child, this.infinite = true});
  @override
...
class _PulseState extends State<Pulse> with SingleTickerProviderStateMixin {
  ...
  @override
  Widget build(BuildContext context) { return ScaleTransition(scale: _animation, child: widget.child); }
}
